<%@ Page Title="Job Application" 
    ...
    CodeBehind="JobApplication.aspx.cs" 
    Inherits="WebApp.SamplePages.JobApplication" %>
        ...
        <div class="col-md-offset-1 col-md-11">
            <div class="alert alert-info">
                <blockquote style="font-style:italic;">
                    This form will illistrate some simple ontrols to fill an online job application. 
                    This form will use basic two column bootstrap formatting with assistance from Bootwrap-Freecode.
                    This form will investigate the processing fo the CheckBoxList. 
                    This blockquoate was formatted using the bootstrapclass alert with an alert-info coloring. 
                    Data will be collected and displayed in a string.
                </blockquote>
            </div>
        </div>
    </div>
